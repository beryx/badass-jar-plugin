...
https://img.shields.io/github/workflow/status/beryx/badass-jar-plugin/build[image:https://github.com/beryx/badass-jlink-plugin/actions?query=workflow%3A%22build%22[Build Status]]
...
=== Prerequisites
The plugin requires Gradle 6.4 or newer. For older Gradle releases you can use version 1.2.0 of this plugin.
