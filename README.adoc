...
=== Prerequisites
The plugin requires Gradle 6.7 or newer. For older Gradle releases you can use https://github.com/beryx/badass-jar-plugin/tree/version-1.x[version 1.2.0] of this plugin.
...
plugins {
    id 'java'
    id 'org.beryx.jar' version '2.0.0-rc-2'
}
